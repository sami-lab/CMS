        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyDesc = table.Column<string>(nullable: false),
                    CompanyLogo = table.Column<string>(nullable: false),
                    CompanyBackgorund = table.Column<string>(nullable: false),
                    whyCooseUsImage = table.Column<string>(nullable: false),
                    whyCooseUsText = table.Column<string>(nullable: false),
                    CompanyAdd = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_AspNetUsers_CompanyOwner",
                        column: x => x.CompanyOwner,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    launch = table.Column<DateTime>(type: "Date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    overviews = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_CompanyOwner",
                table: "Companies",
                column: "CompanyOwner",
                unique: true);
